...
export default class Table extends Component {
  ...
  updateTodo = (id, e) => {
    ...
    this.state.todos.forEach((todo) =>
      todo._id === id ? (todo.isEditStarted = true) : (todo.isEditStarted = false)
    );
                ...
                { this.state.todos.map((todo) => (
                    <tr>
                      ...
                      <td>
                        {todo.isEditStarted === true ? (
                          <>
                            <button className="btn" onClick={ (e) => this.props.handleSave(e, todo)}>Save</button>
                            <button className="btn" onClick={ (e) => this.cancelEdit(e, todo._id)}>Cancel</button>
                          </>
                        ) : (
                          <>
                            <button onClick={(e) => this.updateTodo(todo._id, e)} className="btn" >
                              Edit
                            </button>
                            <button
